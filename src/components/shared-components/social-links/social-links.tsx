...
export default function SocialLinks() {
  ...
  return (
    ...
    <a href="https://github.com/shashanksanket" className="flex flex-col md:flex-row gap-2 items-center">
    ...
    <a href="https://www.instagram.com/shashank.sanket/" className="flex flex-col md:flex-row gap-2 items-center">
    ...
    <a href="mailto:shashank.sanket014@gmail.com" className="flex flex-col md:flex-row gap-2 items-center">
    ...
    <a href="https://www.linkedin.com/in/shashank-sanket-89b30b209/" className="flex flex-col md:flex-row gap-2 items-center">
