...
export default function SocialLinks() {
  ...
  return (
    <div onMouseEnter={() => setIsHover(true)} onMouseLeave={() => setIsHover(false)} className="flex w-full md:w-fit justify-around items-start py-4 px-5 bg-pink-200 bg-opacity-40 shadow-xl shadow-pink-400 rounded-2xl md:flex-col gap-10 hover:ring-4 hover:ring-violet-500 text-white transition-all duration-700 ease-out hover:w-max">
