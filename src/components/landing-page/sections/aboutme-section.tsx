    ...
    <main className="w-full">
      ...
      <div className="flex flex-col mx-10 gap-y-20 justify-center md:flex-row pt-20 md:justify-around">
        ...
        <span className="flex flex-col gap-y-5 p-10 items-center md:items-start">
          ...
          <button className="w-fit rounded-full bg-fuchsia-500 my-10 shadow-2xl shadow-fuchsia-500 text-white px-5 py-2 hover:bg-blue-200 hover:text-black transition-all duration-300">Contact Me</button>
